...
TEST_CASE("Coordinate Calculus: Spaced Vector3 Arithmetic and Space Isolation") {
    GodotCameraVector3 v1(GazeVector3(10.0, 20.0, -30.0));
    GodotCameraVector3 v2(GazeVector3(5.0, -10.0, 15.0));
    ...
    GodotCameraVector3 v3(GazeVector3(0.0, 3.0, 4.0));
...
TEST_CASE("Coordinate Calculus: Spaced Vector2 Arithmetic") {
    GodotDisplayVector2 p1(GazeVector2(100.0, 200.0));
    GodotDisplayVector2 p2(GazeVector2(30.0, 40.0));
...
TEST_CASE("Coordinate Calculus: Spoke-to-Hub OpenCV Camera to Godot Camera Transformation") {
    ...
    OpenCVCameraVector3 cv_pt(GazeVector3(15.0, 25.0, 600.0));
...
TEST_CASE("Coordinate Calculus: Spoke-to-Hub OpenVINO ADAS Gaze Conversion") {
    ...
    OpenVINOGazeVector3 onnx_gaze(GazeVector3(0.1, 0.2, -0.97).normalized());
...
TEST_CASE("Coordinate Calculus: Strongly-Typed Ray-to-Display Pixel Projection") {
    ...
    proj.set_screen_size_pixels(GazeVector2(1440.0, 900.0));
    ...
    GodotCameraVector3 origin_cam(GazeVector3(0.0, -20.0, -350.0));
    // Ray pointing directly forward towards screen center (+Z in Godot Camera space)
    GodotCameraVector3 dir_cam(GazeVector3(0.0, 0.0, 1.0));
