...
TEST_CASE("Screen Projection Engine Boundary Invariants and Realistic Laptop Geometry")
{
    ...
    Gaze::GodotCameraVector3 origin_godot(Gaze::GazeVector3(0.0, -50.0, -650.0));
    Gaze::GodotCameraVector3 dir_godot(Gaze::GazeVector3(0.0, -0.2079, 0.9781)); // pointing toward screen plane in Godot Camera Space
    ...
    Gaze::GodotCameraVector3 off_axis_origin_godot(Gaze::GazeVector3(150.0, -20.0, -600.0));
    Gaze::GodotCameraVector3 off_axis_dir_godot(Gaze::GazeVector3(-0.2425, 0.0323, 0.9696)); // pointing toward screen center
    ...
    Gaze::GodotCameraVector3 away_dir_godot(Gaze::GazeVector3(0.0, 0.0, -1.0)); // pointing backward into room (-Z in Godot Camera space)
